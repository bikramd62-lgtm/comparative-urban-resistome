# ============================================================
# fig_sensitivity_sewage_only_PCoA1_vs_ARG_richness.R
#
# Purpose:
#   Generate the sewage-only ARG-group PCoA1 versus ARG-group
#   richness correlation figure used in the thesis.
#
# Figure:
#   Sewage_only_ARG_group_PCoA1_vs_ARG_richness_BH.png
#
# Input:
...
#   ├── Sewage_only_ARG_group_PCoA1_vs_ARG_richness_BH.png
#   └── Sewage_only_ARG_group_PCoA1_vs_ARG_richness_BH.pdf
# ============================================================
...
# The thesis figure has a positive relationship between richness and PCoA1.
...
write.csv(
  ...
  file = file.path(
    output_dir,
    "Sewage_only_ARG_group_PCoA1_vs_ARG_richness_plot_data.csv"
  ),
  row.names = FALSE
)
...
writeLines(
  ...
  con = file.path(
    output_dir,
    "Sewage_only_ARG_group_PCoA1_vs_ARG_richness_sessionInfo.txt"
  )
)
