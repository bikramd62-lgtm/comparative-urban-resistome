# ============================================================
# fig_sensitivity_pcoa_sewage3M_transit5M.R
#
# Purpose:
#   Generate the PCoA figure for the reduced-depth sensitivity
#   analysis: sewage 3M paired reads versus transit 5M paired reads.
#
# Input:
#   data/processed/sensitivity_analysis/reduced_depth/
#   ├── combined_arg_group_binary_matrix_sewage3M_transit5M_t80_prev10.tsv
#   └── metadata_sewage3M_transit5M_arg_group.tsv
#
# Output:
#   results/sensitivity_analysis/figures/
#   ├── pcoa_arg_group_sewage3M_transit5M_t80_prev10_clean.png
#   └── pcoa_arg_group_sewage3M_transit5M_t80_prev10_clean.pdf
# ============================================================
...
write.csv(
  ...
  file = file.path(
    output_dir,
    "pcoa_arg_group_sewage3M_transit5M_t80_prev10_coordinates.csv"
  ),
  row.names = FALSE
)
