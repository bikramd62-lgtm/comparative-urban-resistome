# ============================================================
# fig_sensitivity_combined_PCoA1_vs_Total_ARG_count.R
#
# Purpose:
#   Generate the combined sewage-transit ARG-group PCoA1 versus
#   total ARG count correlation figure used in the thesis.
#
# Figure:
#   Combined_ARG_group_PCoA1_vs_Total_ARG_count_BH.png
#
# Input:
...
#   ├── Combined_ARG_group_PCoA1_vs_Total_ARG_count_BH.png
#   └── Combined_ARG_group_PCoA1_vs_Total_ARG_count_BH.pdf
# ============================================================
...
# The thesis figure has higher total ARG count toward lower PCoA1 values,
...
write.csv(
  ...
  file = file.path(
    output_dir,
    "Combined_ARG_group_PCoA1_vs_Total_ARG_count_plot_data.csv"
  ),
  row.names = FALSE
)
...
writeLines(
  ...
  con = file.path(
    output_dir,
    "Combined_ARG_group_PCoA1_vs_Total_ARG_count_sessionInfo.txt"
  )
)
