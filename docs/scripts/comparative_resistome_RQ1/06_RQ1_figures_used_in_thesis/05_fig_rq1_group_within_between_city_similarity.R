# ============================================================
# fig_rq1_group_within_between_city_similarity.R
#
# Purpose:
# Generate the RQ1 ARG Group within-city vs between-city
# Jaccard similarity figure used in the thesis.
#
# Input:
# results/rq1/within_between_similarity/rq1_group_within_between_city_similarity_plotdata.tsv
#
# Output:
# results/rq1/figures/rq1_group_within_between_city_jaccard_similarity.png
# results/rq1/figures/rq1_group_within_between_city_jaccard_similarity.pdf
# ============================================================
...
input_file <- file.path(
  input_dir,
  "rq1_group_within_between_city_similarity_plotdata.tsv"
)
...
if (!file.exists(input_file)) {
  stop(
    paste0(
      ...
      input_file,
      "\nRun 04_rq1_within_between_city_similarity.R before generating this figure."
    )
  )
}
...
if (any(is.na(plot_data$Comparison))) {
  stop(
    paste0(
      "Unexpected values found in Comparison column:\n",
      paste(unique(plot_data$Comparison), collapse = "\n")
    )
  )
}
...
# ------------------------------------------------------------
# 7. Generate final thesis figure
# ------------------------------------------------------------
...
png_output <- file.path(
  output_dir,
  "rq1_group_within_between_city_jaccard_similarity.png"
)

pdf_output <- file.path(
  output_dir,
  "rq1_group_within_between_city_jaccard_similarity.pdf"
)

plot_data_output <- file.path(
  output_dir,
  "rq1_group_within_between_city_jaccard_similarity_plotdata.tsv"
)

summary_output <- file.path(
  output_dir,
  "rq1_group_within_between_city_jaccard_similarity_summary.tsv"
)
